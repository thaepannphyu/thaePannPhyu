  ...
  return (
    <div className="bg-[#F7F7FF] dark:bg-[#0E0E17] duration-200 flex flex-col gap-16 justify-center w-[100%]">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-start">
              ...
              <p className="text-black dark:text-gray-300 text-lg font-medium">
                Min Ga lar Taung Nwint. Yangon Division. (or) TharyarWaddy
            ...
            <div className="flex items-start">
              ...
              <p className="text-black dark:text-gray-300 text-lg font-medium break-words">
                <a href="mailto:phyu24655@gmail.com">phyu24655@gmail.com</a>
              </p>
            </div>
            <div className="flex items-start">
              <p>
              ...
              <p className="text-black dark:text-gray-300 text-lg font-medium">
                <a href="tel:09960833035">09 960 833 035</a>
              </p>
            </div>
          </div>
        </div>
      ...
      <div
        ...
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3152.332974115404!2d144.95972717535642!3d-37.80566903357446!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad65d4c2b349649%3A0xb6899234e561db11!2sEnvato!5e0!3m2!1sen!2smm!4v1690094869835!5m2!1sen!2smm"
          width="100%"
          height="380"
          allowFullScreen=""
          loading="lazy"
